...
Timber.sample_changed_callback = function(_) end
Timber.meta_changed_callback = function(_) end
Timber.waveform_changed_callback = function(_) end
Timber.play_positions_changed_callback = function(_) end
Timber.views_changed_callback = function(_) end
...
function Timber.UI.SampleSetup.new(sample_id, index)
  local names_list = UI.ScrollingList.new(4, 30)
  names_list.num_visible = 3
  names_list.num_above_selected = 0

  local params_list = UI.ScrollingList.new(120, 30)
...
function Timber.UI.SampleSetup:set_index(index)
  ...
  self.names_list:set_index(self.index)
  self.params_list:set_index(self.index)
  self.selected_param_name = self.param_names[self.index]
end

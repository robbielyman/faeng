...
-- reset a sprocket's phase;
-- it triggers the next time this lattice processes it.
function Lattice:reset_phase(sprocket)
  sprocket.phase = sprocket.division * self.ppqn * 4 -- "4" because in music a "quarter note" == "1/4"
  sprocket.downbeat = false
end
